  ...
  return ReactDom.createPortal(
    <>
      ...
      <div
        className={
          modalClass +
          (winner == null ? "bg-white" : winner ? "gradient-aqua" : "bg-white")
        }
      >
        ...
        {winner == null ? (
          ...
          <div className="h-[90%] flex flex-col">
            <h3 className="my-auto text-white text-5xl text-center leading-[5rem]">
          ...
          <div className="h-[90%] flex flex-col">
            <h3 className="my-auto text-green-aqua text-8xl text-center leading-[5rem]">
